...
# Copyright (c) 1993 Jan Labanowski 

This program was written by  Jan Labanowski. 
It is open source. I am uploading it to GitHub for preservation:
it is getting more difficult to find on the web.

I have merely added this README file, and the compile-and-install.sh script.
...
See the original documentation is in the translit.txt file (written by Jan Labanowski)
